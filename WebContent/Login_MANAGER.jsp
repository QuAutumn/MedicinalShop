...
<body>
	...
	<div class="photo">
		<table cellpadding="10" align="center">
			<tr>
				<c:forEach var="p" items="${product }">
					...
					<td align="center">
						<p>
							<a href="ProductViewServlet?proid=${p.PRODUCT_ID }"><img
								src="${p.PRODUCT_PHOTO }" width="150" height="150" /></a>
						</p> <a href="ProductViewServlet?proid=${p.PRODUCT_ID }">${p.PRODUCT_NAME }<br />售价:${p.PRODUCT_PRICE }
					</a>
					</td>
				</c:forEach>
			</tr>
		...
		<hr>
		<table align="center">
			<td>共${totalProduct }条记录,当前${page }/${totalPages }页 <a
				href="ProductSearchServlet?page=1">首页</a> <a
				href="ProductSearchServlet?page=${page-1<1?1:page-1 }">上一页</a> <a
				href="ProductSearchServlet?page=${page+1>totalPages?totalPages:page+1 }">下一页</a>
				<a href="ProductSearchServlet?page=${totalPages }">尾页</a>
			</td>
		</table>
	</div>
</body>
