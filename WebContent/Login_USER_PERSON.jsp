			...
			<div id="right_content">
				<div class="maintop">
					<fieldset
						...
						<br>
						<form action="Login_USER_Updatedata.jsp" method="post">
							<p>
								用户名 <input type="text" readonly="true" name="proid"
									value="${userdata.getUSER_ID() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;姓&nbsp;&nbsp;名&nbsp;<input type="text"
									readonly="true" name="uname"
									value="${userdata.getUSER_NAME() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;密&nbsp;&nbsp;码&nbsp;<input type="text"
									readonly="true" name="upwd"
									value="${userdata.getUSER_PASSWORD() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;性&nbsp;&nbsp;别&nbsp;<input type="text"
									readonly="true" name="usex" value="${userdata.getUSER_SEX() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;生&nbsp;&nbsp;日&nbsp;<input type="text"
									readonly="true" name="ubirth"
									value="${userdata.getUSER_BIRTHDAY() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;手&nbsp;&nbsp;机&nbsp;<input type="text"
									readonly="true" name="uphone"
									value="${userdata.getUSER_PHONE() }">
							</p>
							<br>
							<p>
								&nbsp;&nbsp;地&nbsp;&nbsp;址&nbsp;
								<textarea cols="17" rows="2" readonly="true" name="uaddress">${userdata.getUSER_ADDRESS() }</textarea>
							</p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
								style="background-color: #6495ED; color: white; width: 140px; height: 30px;"
