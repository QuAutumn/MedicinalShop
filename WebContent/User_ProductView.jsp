...
<body>
	...
	<div class="maintop">
		<center>
			<form name="regForm" action="UserAddProductCart" method="post">
							...
							<table>
								...
								<tr>
									<td><input
										...
										type="submit" value="加入购物车"></td>
								</tr>
								<tr>
									<td><input
										style="color: white; background-color: red; height: 45; width: 150;"
										type="button" value="直接购买" onClick="checkorder()" class="buy"></td>
								</tr>
							</table>
						</td>
					</tr>
	...
	<script type="text/javascript">
		...
		function checkorder() {
			var pronum = document.regForm.pronum.value;
			location.href="Login_User_Order.jsp?pronum="+pronum;
		}
	</script>
</body>
</html>